...
case class GeoIP(countryCode : String, countryName : String, region : String, regionName : String,
...
// For Result
case class Return(status : String, result : String)
...
object TemplarObjects extends DefaultJsonProtocol with SprayJsonSupport with NullOptions {
	...
	implicit val geoIpFormat = jsonFormat12(GeoIP)
